...
replace (
	github.com/harvester/harvester-installer => github.com/harvester/harvester-installer v1.2.1
	github.com/mudler/entities v0.0.0-20211108084227-d1414478861b => github.com/mudler/entities v0.8.1
	github.com/tredoe/osutil v1.3.6 => github.com/tredoe/osutil v1.5.0
